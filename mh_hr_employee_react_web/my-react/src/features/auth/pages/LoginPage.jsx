      ...
      >
        <div className="bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 overflow-hidden">
          <div className="flex flex-col md:flex-row bg-white dark:bg-slate-900">
            ...
            <div className="flex-1 p-8 md:p-12 flex flex-col justify-center w-full md:w-2/3">
              <motion.div
            ...
            {/* Right Side - Logo Display - ALWAYS VISIBLE */}
            <div className="flex flex-col justify-center items-center p-8 md:p-12 border-t md:border-t-0 md:border-l border-slate-200 dark:border-slate-700 w-full md:w-1/3">
              <motion.div
              ...
              >
                <div className="w-48 h-48 md:w-56 md:h-56 bg-white dark:bg-white rounded-2xl p-6 shadow-2xl border-4 border-purple-300 dark:border-purple-500">
                  <img
                    src={logo}
                    alt="Company Logo"
